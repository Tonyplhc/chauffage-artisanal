 ...
 *   - Discret : bulle noire avec un point pulsant copper (pas le vert WhatsApp
...
export function WhatsAppCta() {
  ...
  return (
    <>
      ...
      {open && (
        <div
          className="fixed bottom-24 right-5 lg:right-7 z-[55] w-72 p-4 rounded-2xl bg-white border border-ink/10 shadow-lift"
        ...
        >
          <div className="flex items-start justify-between gap-3 mb-3">
            ...
            <button
              ...
              className="h-7 w-7 grid place-items-center rounded-full bg-cream border border-ink/10 text-graphite hover:bg-ink hover:text-cream transition-colors shrink-0"
              aria-label="Fermer"
            >
          ...
          <a
            ...
            className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-full bg-ink text-cream px-4 py-2.5 text-sm font-medium hover:bg-copper transition-colors"
          >
      ...
      <button
        ...
        className={`fixed bottom-5 right-5 lg:bottom-7 lg:right-7 z-[55] h-14 w-14 lg:h-16 lg:w-16 rounded-full bg-ink text-cream shadow-lift border border-ink/20 grid place-items-center transition-all hover:bg-copper hover:scale-105 ${
      ...
      >
        ...
        <span className="absolute -top-0.5 -right-0.5 flex h-3 w-3">
          ...
          <span className="relative inline-flex h-3 w-3 rounded-full bg-copper border-2 border-ink" />
        </span>
      </button>
    </>
  );
