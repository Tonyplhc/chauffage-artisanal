        ...
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5">
            ...
            <Reveal>
              <h2 className="mt-5 font-display text-display-lg text-balance text-anthra">
                <em className="not-italic text-bleu">Tout le Grand-Duché</em>. Et au-delà.
              </h2>
            </Reveal>
            <Reveal delay={1}>
              <p className="mt-6 text-taupe">
                Nos équipes interviennent sur{" "}
                <strong className="text-bleu font-semibold">
            ...
            <div className="mt-10 grid sm:grid-cols-3 gap-px bg-sable/60 border border-pierre rounded-xl overflow-hidden">
              <div className="bg-white px-5 py-6">
                <div className="font-mono text-[10px] uppercase tracking-eyebrow text-muted">
                  Zone
                </div>
                <div className="mt-2 font-display text-2xl text-bleu">Grand-Duché</div>
              </div>
              <div className="bg-white px-5 py-6">
                <div className="font-mono text-[10px] uppercase tracking-eyebrow text-muted">
                  Intervention
                </div>
                <div className="mt-2 font-display text-2xl text-bleu">Selon disponibilité</div>
              </div>
              <div className="bg-white px-5 py-6">
                <div className="font-mono text-[10px] uppercase tracking-eyebrow text-muted">
                  Astreinte
                </div>
                <div className="mt-2 font-display text-2xl text-bleu">Sur demande</div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7">
            <motion.div
              ...
              className="relative aspect-[5/4] rounded-3xl overflow-hidden border border-pierre bg-creme shadow-soft"
            >
              <iframe
                src={OSM_EMBED}
              ...
              <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-creme/95 via-creme/70 to-transparent p-5 pointer-events-none">
                <div className="flex items-center justify-between gap-3 flex-wrap pointer-events-auto">
                  <div className="flex items-center gap-2 text-xs font-mono uppercase tracking-eyebrow text-anthra/80">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-creme/95 backdrop-blur border border-pierre text-[10px] font-mono uppercase tracking-eyebrow text-anthra hover:bg-creme transition-colors shadow-soft"
                  >
                    Voir sur OSM
        ...
        <div className="mt-8 flex flex-wrap gap-2.5">
          {CITIES.map((city) => (
            <Link
              ...
              className="px-4 py-1.5 rounded-full border border-pierre bg-white text-sm text-taupe hover:border-bleu/50 hover:text-bleu transition-colors"
            >
              {city.label}
            </Link>
          ))}
